...
- https://github.com/jonathanjwatson/express-starter
- https://youtu.be/LR85uZ5p-v8
...
* Mac: `killall node`
* Windows: `taskkill /f /im node.exe` (must be run from command line, not bash)
